...
def excelWriter2(writer, df,  worksheetName, figure1, figure2,spectrumSplit,xcorr, prob,lscoreSite, massSeriesLength, matched, seqSymbol, peptide, N=34, updater=0):
